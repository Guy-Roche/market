            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-pane" id="settings">
                        <form method="post" action="{{ route('rolepermission.update', $rolePermission->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="hidden" name="role_id" class="form-control" value="{{ $rolePermission->id   }}"
                                            id="role_id">
                                        <h3>{{ $rolePermission->name }}</h3>
                                    </div>
                                </div> <!-- end row -->
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="form-check mb-2 form-check-blue">
                                                <input class="form-check-input" type="checkbox" value=""
                                                    id="customckeck1" 
                                                    {{ App\Models\User::hasRoleAndPermission($rolePermission, $permissions) ? 'checked' : '' }}>
                                            ...
                                            @foreach ($permissions as $permission)
                                                <div class="form-check mb-2 form-check-blue">
                                                    <input class="form-check-input" type="checkbox" name="permission[]"
                                                        value="{{ $permission->id }}" id="customckeck{{ $permission->id }}" {{ $rolePermission->hasPermissionTo($permission->name) ? 'checked' : '' }}>
                                                    <label class="form-check-label"
