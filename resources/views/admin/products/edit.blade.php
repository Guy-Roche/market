            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-pane" id="settings">
                        <form method="post" id="myForm" action="{{ route('product.update', $product->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control " id="name"
                                            placeholder="Enter product name" name="product_name" value="{{ $product->product_name }}">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <img id="showImage" src="{{ $product->product_image ? asset('backend/images/products/' . $product->product_image) : asset('backend/images/no_image.jpg') }}"
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-success waves-effect waves-light mt-2"><i
                                        class="mdi mdi-content-save"></i> Update Product</button>
                            </div>
                        </form>
                    </div>
